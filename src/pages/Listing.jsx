...
import {useGetlistProductConfig,useUpdateProductConfigParams,useProductConfigQueryParams} from '../hook/list';
...
export default function Listing() {
  ...
  const [list,isLoading] = useGetlistProductConfig(query)
  // useEffect(() => {
